...
class RedisLikeServer:
    ...
    def _event_loop(self):
        while self.running:
            ...
            for client_socket in ready_read:
                if client_socket is not self.server_socket:
    ...
    def _accept_new_connection(self):
        try:
            ...
            # nothing to accept (non-blocking)
            return
        except socket.error:
            return
    ...
    def _handle_client_data(self, client_socket):
        try:
            ...
            self.client_buffers[client_socket] += decoded
    ...
    def _process_client_buffer(self, client_socket):
        buffer = self.client_buffers.get(client_socket, "")
        # normalize CRLF to LF for easier splitting
